...
//		}
		...
		UserAccount userAccount = userRepository.findById(auth).get();
...
//		}
	...
	@Override
	public Set<String> addRole(String id, String role, String login) {
//		AccountUserCredentials credentials = accountConfiguration.tokenDecode(auth);
...
//		}
	...
	@Override
	public Set<String> removeRole(String id, String role, String login) {
		UserAccount admin = userRepository.findById(login).get();
		if (!admin.getRoles().contains("Admin")) {
			throw new ForbiddenException();
		}
